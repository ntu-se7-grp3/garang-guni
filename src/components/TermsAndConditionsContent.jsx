function TermsAndConditionsContent() {
  return (
    <>
      <p>
        Welcome to The Garang Guni Website!
      </p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of ntu-se7-grp3 Pte Ltd's Website, located at https://garang-guni.netlify.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use The Garang Guni if you do not agree to 
      ...
      <p>
        Unless otherwise stated, ntu-se7-grp3 Pte Ltd and/or its licensors own the
        intellectual property rights for all material on The Garang Guni. All 

        intellectual property rights are reserved. You may access this from The 
        Garang Guni for your own personal use subjected to restrictions set in 
      ...
      <ul>
        <li>
          Republish material from The Garang Guni
        </li>
        <li>
          Sell, rent or sub-license material from The Garang Guni
        </li>
        <li>
          Reproduce, duplicate or copy material from The Garang Guni
        </li>
        <li>
          Redistribute content from The Garang Guni
        </li>
      </ul>
      ...
      <p>
        ...
        the hyperlink compensates the absence of ntu-se7-grp3 Pte Ltd; and (d) the
      ...
      <p>
        No use of ntu-se7-grp3 Pte Ltd's logo or other artwork will be allowed for
