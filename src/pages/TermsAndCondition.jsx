function TermsAndConditionsContent() {
  return (
    <>
      <p>Welcome to The Garang Guni Website!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of ntu-se7-grp3 Pte Ltd's Website,
        located at https://garang-guni.netlify.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use The Garang
        Guni if you do not agree to take all of the terms and conditions stated on this page.
      </p>
      ...
      <p>
        ...
        Company's stated services, in accordance with and subject to, prevailing law of sg. Any use of the above
      ...
      <p>
        We employ the use of cookies. By accessing The Garang Guni, you agreed to use cookies in agreement with the
        ntu-se7-grp3 Pte Ltd's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, ntu-se7-grp3 Pte Ltd and/or its licensors own the intellectual property rights for all
        material on The Garang Guni. All intellectual property rights are reserved. You may access this from The Garang
        Guni for your own personal use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from The Garang Guni</li>
        <li>Sell, rent or sub-license material from The Garang Guni</li>
        <li>Reproduce, duplicate or copy material from The Garang Guni</li>
        <li>Redistribute content from The Garang Guni</li>
      </ul>
      ...
      <p>
        ...
        areas of the website. ntu-se7-grp3 Pte Ltd does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions of ntu-se7-grp3 Pte Ltd,its agents
        and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, ntu-se7-grp3 Pte Ltd shall not be liable for the Comments or for any
        liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or
        appearance of the Comments on this website.
      </p>

      <p>
        ntu-se7-grp3 Pte Ltd reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant ntu-se7-grp3 Pte Ltd a non-exclusive license to use, reproduce, edit and authorize others to
      ...
      <p>
        ...
        ntu-se7-grp3 Pte Ltd; and (d) the link is in the context of general resource information.
      </p>
      ...
      <p>
        ...
        you must inform us by sending an e-mail to ntu-se7-grp3 Pte Ltd. Please include your name, your organization
        name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to
        our Website, and a list of the URLs on our site to which you would like to link. Wait 20-30 years for a
        response.
      </p>
      ...
      <p>
        No use of ntu-se7-grp3 Pte Ltd's logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
