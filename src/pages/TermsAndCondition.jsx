  ...
  return (
    <>
      ...
      <p>
        ...
        of ntu-se7-grp3 Pte Ltd's Website, located at
        https://garang-guni.netlify.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use The Garang Guni if you do not agree
      ...
      <p>
        ...
        subject to, prevailing law of sg. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing The Garang Guni, you agreed
        to use cookies in agreement with the ntu-se7-grp3 Pte Ltd's Privacy
        Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, ntu-se7-grp3 Pte Ltd and/or its licensors own
        the intellectual property rights for all material on The Garang Guni.
        All intellectual property rights are reserved. You may access this from
        The Garang Guni for your own personal use subjected to restrictions set
      ...
      <p>
        ...
        ntu-se7-grp3 Pte Ltd does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of ntu-se7-grp3 Pte Ltd,its agents and/or affiliates.
        ...
        ntu-se7-grp3 Pte Ltd shall not be liable for the Comments or for any
      ...
      <p>
        ntu-se7-grp3 Pte Ltd reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant ntu-se7-grp3 Pte Ltd a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of ntu-se7-grp3 Pte Ltd; and (d)
      ...
      <p>
        ...
        e-mail to ntu-se7-grp3 Pte Ltd. Please include your name, your
        ...
        list of the URLs on our site to which you would like to link. Wait 20-30
      ...
      <p>
        No use of ntu-se7-grp3 Pte Ltd's logo or other artwork will be allowed
